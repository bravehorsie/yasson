...
public interface YassonJsonb extends javax.json.bind.Jsonb {
     ...
     *      If any of the parameters is {@code null}.
     */
    <T> T fromJson(JsonStructure jsonStructure, Class<T> type) throws JsonbException;
     ...
     *      If any of the parameters is {@code null}.
     */
    <T> T fromJson(JsonStructure jsonStructure, Type runtimeType) throws JsonbException;
