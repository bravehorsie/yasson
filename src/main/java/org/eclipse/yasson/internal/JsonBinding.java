...
public class JsonBinding implements YassonJsonb {
    ...
    @Override
    public <T> T fromJson(JsonStructure jsonStructure, Class<T> type) throws JsonbException {
    ...
    @Override
    public <T> T fromJson(JsonStructure jsonStructure, Type runtimeType) throws JsonbException {
        JsonParser parser = new JsonbRiParser(new JsonStructureToParserAdapter(jsonStructure));
